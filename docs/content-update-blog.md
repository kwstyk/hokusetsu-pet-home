...
### 2-5. ブログ更新（`docs/content-update-blog.md`）
...
```md
---
title: "北摂でペット可物件を探すときに最初に決めておきたい3つのこと"
slug: "pet-basics-hokusetsu"
description: "「駅」「ペットの条件」「家賃上限」の3つに絞って解説します。"
tags: ["基礎知識", "ペット可", "北摂"]
...
* SEO だけを狙うのではなく、「LINEで話す前の予習」として書く
* `/first-time` より詳しい解説・裏話を書くイメージ
* 無理に更新頻度を上げない（事例・ガイド優先）
